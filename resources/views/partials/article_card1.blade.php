<div class="card h-100 w-60 d-flex flex-column justify-content-between">
  <div class="card-body">
    <a href="{{ route('actualites.show', $article) }}" class="text-decoration-none">
      <p class="card-title">{{ tronquerTexte($article->title,50) }}</p>
    </a>
    <p class="card-text">{{ tronquerTexte($article->description,65) }}</p>
    <div style="margin-top:-3%;" class="row">
      ...
      <div class="col card-text offset-0" style="font-size: 12px; margin-left:-45%; margin-top:2%;">
  ...
  <a href="{{ route('actualites.show', $article) }}">
    <img src="{{ $article->getFirstMediaUrl('post-image') }}" class="card-img-bottom" alt="..." style="height: 107px;">
  </a>
</div>
